...
func TestVocabulary_Match_AddressRegression_bug2(t *testing.T) {
	...
	got := vocab.Match("广州经济技术开发区永和经济区永顺大道西路2号", MatchOpts().WithDefaultRegionAliases())
...
func TestVocabulary_Match_AddressRegression_bug3(t *testing.T) {
	...
	got := vocab.Match("新郑市华南城7B-1-524号", MatchOpts().WithDefaultRegionAliases())
...
func TestVocabulary_Match_AddressRegression_bug5(t *testing.T) {
	...
	got := vocab.Match("新郑华南城7B-1-524号", MatchOpts().WithDefaultRegionAliases())
...
func TestVocabulary_Match_AddressRegression_bug6(t *testing.T) {
	...
	got := vocab.Match("中国四", MatchOpts().WithDefaultRegionAliases())
	logutil.Log(got)
}
